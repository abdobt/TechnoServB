...
<div class="card">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="email" id="exampleInputPassword1" value=<%=a.getEmail() %>>
  </div>
    <div class="mb-3">
    <label  class="form-label">Password</label>
    <input type="password" class="form-control" name="password" id="exampleInputPassword1" value=<%=a.getPassword() %>>
  </div>
    <div class="mb-3">
    <label  class="form-label">City</label>
    <input type="text" class="form-control" name="ville" id="exampleInputPassword1" value=<%=a.getVille() %>>
  </div>
    <div class="mb-3">
    <label  class="form-label">Phone number</label>
    <input type="text" class="form-control" name="phone_num" id="exampleInputPassword1" value=<%=a.getPhone_num() %>>
  </div>
  <div class="mb-3">
