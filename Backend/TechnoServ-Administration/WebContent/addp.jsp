...
<div class="col-6">
<div class="card">
  <h5 class="card-header">Ajouter un technicien</h5>
  <div class="card-body">
  ...
  <div class="mb-3">
    <label  class="form-label">id_specialite</label>
    <input type="number" class="form-control" name="id_specialite" id="exampleInputPassword1" >
  </div>
